...
const tiers = [
  {
    tier: 1, level: "Silver", name: "Silver Package", price: "From TZS 2M",
    ...
    inclusions: ["3–5 nights accommodation", "Return flights included", "4-star hotel stay", "Private airport transfers", "Romantic dinner setup", "Travel consultation"],
  },
  {
    tier: 2, level: "Gold", name: "Gold Package", price: "From TZS 4M",
    ...
    inclusions: ["5–7 nights accommodation", "Economy or Business class option", "5-star resort stay", "VIP airport meet & greet", "Couples spa experience", "Travel insurance included"],
  },
  {
    tier: 3, level: "Platinum", name: "Platinum Package", price: "From TZS 6M",
  ...
  {
    tier: 4, level: "Royal", name: "Royal Experience", price: "From TZS 8M",
    ...
    inclusions: ["10+ nights ultra-luxury stay", "First or Business class flights", "Private villa + charter option", "24/7 dedicated concierge", "Exclusive private experiences", "Welcome hamper + surprise touches"],
  },
];
        ...
        <div className="section-container">
          <div className="text-center mb-14">
            ...
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              ...
              Your Perfect Honeymoon,{" "}<span className="text-[#f5921e]">Your Way</span>
            </motion.h2>
                ...
                <form onSubmit={handlePlanSubmit} className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <select name="package" value={form.package} onChange={handleChange} className={inputClass}>
                      ...
                      <option value="Silver Package — From TZS 2M" className="text-gray-800">Silver Package — From TZS 2M</option>
                      <option value="Gold Package — From TZS 4M" className="text-gray-800">Gold Package — From TZS 4M</option>
                      <option value="Platinum Package — From TZS 6M" className="text-gray-800">Platinum Package — From TZS 6M</option>
                      <option value="Royal Experience — From TZS 8M" className="text-gray-800">Royal Experience — From TZS 8M</option>
                    </select>
                  </div>
                  <div>
