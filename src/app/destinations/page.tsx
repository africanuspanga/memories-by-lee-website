      ...
      <section id="mafia" className="relative overflow-hidden bg-navy">
        ...
        <div className="section-container relative z-10 py-28 lg:py-36">
          <div className="max-w-2xl">
            ...
            >
              Mafia Island is Tanzania&apos;s best-kept secret: powder-white beaches
              stretching to the horizon, crystal-clear Indian Ocean waters, and some
              of the most intimate boutique resorts in all of Africa. This is where
              couples come to celebrate love in its most beautiful setting. World-class
